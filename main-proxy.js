        ...
        while (true) {
            for (let i = 0; i < data.length; i++) {
                ...
                if (proxy) {
                   ...
                   this.log('No proxies available', 'warning');
                    ...
                    if (userInfoResult.success) {
                        ...
                        if (!lastClaimedTime || currentTime > lastClaimedTime.plus({ hours: 2, minutes: 5 })) {
                            ...
                            if (!boosterResult.success) {
                                this.log(`Unable to retrieve booster: ${boosterResult.error}`, 'error');
                        ...
                        if (spins > 0) {
                            this.log(`Starting to shoot with ${spins} spins`, 'yellow');
                        ...
                        this.log(`Cannot get user information! Status: ${userInfoResult.status || userInfoResult.error}`, 'error');
